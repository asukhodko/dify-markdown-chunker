...
"""
        ...
        paths = [
            c.metadata.get("header_path")
            for c in chunks
            if c.metadata.get("header_path")
        ]
        assert len(paths) >= 1
...
class TestSPEC036ContentTypeDetection:
    ...
    **Validates: Requirements 3.1, 5.1**
    ...
    def test_mixed_content_type(self):
        ...
        assert "mixed" in content_types or (
            "code" in content_types and "table" in content_types
        )
...
class TestSPEC033APIBackwardCompatibility:
    ...
    **Validates: Requirements 3.1, 5.1**
    ...
    def test_chunk_simple_with_config_dict(self):
        ...
        chunker = MarkdownChunker()
        result = chunker.chunk_simple("Test content", config={"max_chunk_size": 1000})
    ...
    def test_config_from_dict(self):
        ...
        data = {"max_chunk_size": 2048, "min_chunk_size": 256, "overlap_size": 100}
