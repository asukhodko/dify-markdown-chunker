...
from markdown_chunker_v2.strategies import FallbackStrategy, StrategySelector
...
"""
    ...
    def test_code_aware_preserves_code_blocks(self):
        ...
        config = ChunkConfig(
            max_chunk_size=100, overlap_size=20, strategy_override="code_aware"
        )
...
"""
    ...
    def test_structural_splits_at_headers(self):
        ...
        config = ChunkConfig(
            max_chunk_size=200, overlap_size=50, strategy_override="structural"
        )
        chunker = MarkdownChunker(config)
...
class TestSPEC018FallbackStrategy:
    ...
    **Reference**: docs/v2-test-specification/v2-test-specification.md#SPEC-018
    ...
    def test_fallback_splits_at_paragraphs(self):
        ...
        config = ChunkConfig(
            max_chunk_size=100, overlap_size=20, strategy_override="fallback"
        )
        chunker = MarkdownChunker(config)
...
"""
    ...
    def test_fallback_respects_size_constraints(self):
        ...
        config = ChunkConfig(
            max_chunk_size=200, overlap_size=50, strategy_override="fallback"
        )
        chunker = MarkdownChunker(config)
...
"""
    ...
    def test_no_override_auto_selects(self):
        ...
        if plain_chunks:
            ...
            assert plain_chunks[0].metadata["strategy"] in [
                "fallback",
                "structural",
                "code_aware",
            ]
