...
class BaseStrategy(ABC):
    ...
    def _set_oversize_metadata(
        ...
        Called by strategy when creating a chunk that exceeds max_chunk_size
        for a valid reason (preserving atomic blocks).
        
        Args:
            chunk: Chunk to mark
            reason: Reason for oversize (code_block_integrity, table_integrity, section_integrity)
