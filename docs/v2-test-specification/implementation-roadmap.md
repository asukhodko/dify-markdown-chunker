...
- [Test Intent Analysis](./test-intent-analysis.md) — анализ 3188 legacy-тестов
...
- [Analysis Script](../../scripts/analyze_p1_tests.py) — скрипт анализа legacy-тестов
- [Original Spec](../../.kiro/specs/p1-test-specification/) — исходная спецификация
