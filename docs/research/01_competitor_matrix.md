...
**Unique Features:**
- SemanticChunker с -based boundaries
...
| Chonkie | SemanticChunker с | **HIGH PRIORITY** - semantic boundary detection |
...
1. **Semantic boundary detection** — Chonkie имеет -based boundaries
...
- Use sentence to detect topic shifts
