...
"text--ada-002": "cl100k_base",
"text--3-small": "cl100k_base",
}
...
@classmethod
def for_models(cls, max_tokens: int = 8191) -> "ChunkConfig":
"""Конфигурация для models."""
return cls(
use_token_sizing=True,
max_tokens=max_tokens,
token_model="text--3-small"
)
```
## Тестирование
### Unit Tests
