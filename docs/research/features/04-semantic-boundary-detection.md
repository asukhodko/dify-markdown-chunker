...
## Краткое описание
Использование sentence для определения оптимальных границ чанков на основе семантических переходов между параграфами. Значительное улучшение качества chunking.
## Метаданные
| Параметр | Значение |
|----------|----------|
...
"""
Определение семантических границ с использованием .
"""
def __init__(
self,
...
### Оптимизации
1. **Caching** — кешировать для повторных запросов
