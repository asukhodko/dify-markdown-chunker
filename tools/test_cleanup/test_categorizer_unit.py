...
class TestTestCategorizerUnit:
    ...
    def test_categorize_mixed_tests(self):
        ...
        assert (
            len(categorization.valuable_tests) == 3
        )  # All legacy tests marked as valuable initially
    ...
    def test_identify_duplicates_high_overlap(self):
        ...
        # Should identify as duplicate due to high overlap
        # (2/3 = 0.67 > 0.8 threshold? No)
        ...
        # The unique coverage should include "validation" (from legacy) and
        # "formatting" (from migration)
    ...
    def test_identify_duplicates_exact_match(self):
        ...
        assert duplicate_report.duplicate_pairs[0] == (
            "test_legacy.py",
            "test_migration.py",
        )
    ...
    def test_categorization_totals(self):
        ...
        # Should have 3 legacy tests (even indices) and
        # 3 migration-compatible (odd indices)
